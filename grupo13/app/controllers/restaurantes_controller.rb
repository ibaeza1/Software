class RestaurantesController < ApplicationController
  ...
  def create
    ...
    puts('1234556778888a88as8888')
    @restaurantes = Restaurante.new(params[:restaurante].permit(:titulo, :correo, :direccion, :valoracion, :telefono, :url))
  ...
  private
    def restaurante_params
      params.require(:restaurante).permit(:titulo, :correo, :direccion, :valoracion, :telefono, :url)
    end
