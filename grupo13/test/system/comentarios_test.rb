...
class ComentariosTest < ApplicationSystemTestCase
  ...
  test "creating a Comentario" do
    ...
    fill_in "Fecha y hora", with: @comentario.fecha_y_hora
    fill_in "Puntaje de reputacion", with: @comentario.puntaje_de_reputacion
    fill_in "Restaurante o plato", with: @comentario.restaurante_o_plato
    fill_in "Usuario", with: @comentario.usuario
